...
output "mssql_connect_string" {
  ...
  value       =  "Server=tcp:${azurerm_mssql_server.demo.fully_qualified_domain_name} Database=${azurerm_sql_database.training.name};User ID=${azurerm_mssql_server.demo.administrator_login};Password=${azurerm_mssql_server.demo.administrator_login_password};Trusted_Connection=False;Encrypt=True;"
}
